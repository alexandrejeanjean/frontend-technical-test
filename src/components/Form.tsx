...
const Form = () => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <label htmlFor="messageInput" className="font-bold text-primary-blue">
                Votre message
            </label>
            <div className="relative mt-1.5">
                <label className="sr-only">"Votre message"</label>
                <input type="text" id="messageInput" name="message" value={message} onChange={handleChange} className="w-full min-h-[50px] pl-5 pr-10 bg-gray-50 rounded-full" />
